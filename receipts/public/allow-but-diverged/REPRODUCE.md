...
3. Run `npm test`.
4. The demo test suite rebuilds `allow-but-diverged` from the committed synthetic fixture state.
...
9. The expected final correspondence verdict is `DIVERGED`.
